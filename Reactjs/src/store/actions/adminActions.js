...
import { getAllCodeService, createNewUserService, getAllUsers, deleteUserService, editUserService,
     getTopDoctorHomeService, getAllDoctors, saveDetailInforDoctor, getAllSpecialty, getAllClinic } from "../../services/userService";
...
export const saveDetailDocTors = (data) => {
    return async (dispatch, getState) => {
        try {
            ...
            if (res && res.errCode === 0) {
                toast.success("Save Infor Detail Doctor");
                dispatch({
