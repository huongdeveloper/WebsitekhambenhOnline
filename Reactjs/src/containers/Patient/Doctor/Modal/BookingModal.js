...
import { postBookAppointmet } from '../../../../services/userService';
...
class BookingModal extends Component {
    ...
    // ==========  Thông tin Gửi Email, Chuyển đổi ngôn ngữ =========
    ...
    handleConfirmBooking = async () => {
        ...
        let res = await postBookAppointmet({
        ...
        if (res && res.errCode === 0) {
            toast.success("Booking a new appointemt success");
            this.props.closeBookingClose() 
        }else {
            toast.error(" Booking a new appointemt error! ");
        }
            ...
            <Modal 
                ...
                <div className='booking-modal-content'>
                    <div className='booking-modal-header'>
                        <span className='left'><FormattedMessage id="patient.booking-modal.left-text"/></span>
                        <span className='right' onClick={closeBookingClose}><i className="fa-solid fa-xmark"></i></span>
                    </div>
                    ...
                    <div className='booking-modal-footer'>
                        <button className='btn btn-primary btn-booking-conform' onClick={() => this.handleConfirmBooking()}>
                        <FormattedMessage id="patient.booking-modal.save"/>  </button>
                        <button className='btn btn-danger btn-booking-cancel' onClick={closeBookingClose} > 
