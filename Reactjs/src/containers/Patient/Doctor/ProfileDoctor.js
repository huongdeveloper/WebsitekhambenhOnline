...
class ProfileDoctor extends Component {
    ...
    render() {
        ...
        return (
            ...
            {isShowLinkDetail === true && <div className=''>
            ...
            <div className='price'><FormattedMessage id="patient.booking-modal.price"/>:
                ...
                && <NumberFormat className='currency' value={dataProfile.Doctor_infor.priceTypeData.valueVi} 
                displayType={'text'} thousandSeparator={true} suffix={'đ'}/>} 

                { dataProfile && dataProfile.Doctor_infor && language === LANGUAGES.EN
                && <NumberFormat className='currency' value={dataProfile.Doctor_infor.priceTypeData.valueEn} 
