    ...
    render() {
        ...
        return (
            <Modal 
                ...
                <ModalFooter>
                    <Button className='px-3' color="primary" onClick={() => this.handSendRemedy()}> Send </Button>{' '}
                    <Button className='px-3' color="secondary" onClick={closeRemedyModal}> Cancel </Button>
                </ModalFooter>
            </Modal>
        );
    }
