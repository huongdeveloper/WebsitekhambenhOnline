        ...
        return (
            <div className='manage-doctor-container'>
                ...
                <div className='more-infor'>
                    ...
                    <div className='content-right'>
                        ...
                        <textarea className='form-control'
                          onChange={(event) => this.handleOnChangeText(event, 'description')} value={this.state.description}
                        ></textarea>
                    </div>
                ...
                <div className='more-infor-etra row'>
                        ...
                        <div className='col-4 form-group'>
                            <label><FormattedMessage id="admin.manage-doctor.specialties"/>:</label>
                            <Select
                            value={this.state.selectedSpecialty}
                            onChange={this.handleChangeSelectDOctorInfor}
                            name= "selectedSpecialty"
                            options={this.state.listSpecialty}
                            placeholder={<FormattedMessage id="admin.manage-doctor.specialties"/>}
                        />
                        </div>
                        <div className='col-4 form-group'>
                ...
                <div className='manage-doctor-editor'>
                    <label><FormattedMessage id="admin.manage-doctor.detail"/>:</label>
                <MdEditor style={{ height: '500px' }} renderHTML={text => mdParser.render(text)} onChange={this.handleEditorChange} 
                value={this.state.contentMarkdown}/>
                </div>
                <button className={hasOldData === true ? "btn btn-warning" : "btn btn-primary"} style={{width: 100, marginTop: 20}} 
                  onClick={() => this.handleSaveContentMarkdown()}
                > {hasOldData === true ? <span><FormattedMessage id="admin.manage-doctor.save"/></span> : <span><FormattedMessage id="admin.manage-doctor.add"/></span>}  </button>
            </div>
        );
    }
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getRequireDoctorInfor: () => dispatch(actions.getRequiredDoctorInfor()),
    };
};
