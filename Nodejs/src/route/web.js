...
let initWebRoutes = (app) => {
    ...
    router.post('/api/patient-book-appointmet', patientController.postBookAppointmet);
    router.post('/api/verify-book-appointmet', patientController.postVerifyBookAppointmet);
    
    router.post('/api/create-new-specialty', spcialtyController.postCreateNewSpecialty);
